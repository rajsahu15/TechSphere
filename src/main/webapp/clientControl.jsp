...
<head>
  ...
  <title>Clients Registered</title>
...
<% ArrayList<RegisterClient> alist = (ArrayList<RegisterClient>) request.getAttribute("ClientLIST");%>
    ...
    <div class="d-flex flex-column">
      ...
      <nav id="navbar" class="nav-menu navbar">
        <ul>
          ...
          <li><a href="#" class="nav-link scrollto active"><i class="bx bx-book-content"></i> <span>Registered Clients</span></a></li>
...
if(alist != null)
{
for(RegisterClient rClient : alist )	
{ %>
<tr>
<td><%= rClient.getUsername() %></td>
<td><%= rClient.getPassword()  %></td>
<td><%= rClient.getLogtype() %></td>
<td><a class="btn btn-danger" href="clientDelete?username=<%=rClient.getUsername()%>" onclick=" return confirm('Deleting Client')">DELETE</a></td>
</tr>
<% } }%>
</table>
</div>
