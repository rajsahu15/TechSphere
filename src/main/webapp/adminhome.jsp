  ...
  <header id="header">
    <div class="d-flex flex-column">
      ...
      <nav id="navbar" class="nav-menu navbar">
        <ul>
          <li><a href="#hero" class="nav-link scrollto active"><i class="bx bx-home"></i> <span>Admin Home</span></a></li>
          <li><a href="enquiryController" class="nav-link scrollto"><i class="bx bx-user"></i> <span>Pending Requests</span></a></li>
        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="assets/img/img11.png" height="500" width="700"  alt="">
                </div>

                <div class="swiper-slide">
                  <img src="assets/img/img12.png" height="500" width="700"   alt="">
                </div>

                <div class="swiper-slide">
                  <img src="assets/img/img13.png"  height="500" width="700" alt="">
                </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              ...
              <ul>
                <li><strong>Welcome Admin</strong>:<%if(ss!=null){out.print(" "+ss.toUpperCase());} %></li>
            ...
            <div class="portfolio-description">
              <h2>Working Notes:</h2>
              <p>
             Whatever You Want to perform the task or the admin controls should be managed from here and only the developer should have the authority to access it.</p>
            </div>
          </div>
