      ...
      <nav id="navbar" class="nav-menu navbar">
        <ul>
          <li><a href="index.jsp" class="nav-link scrollto active"><i class="bx bx-home"></i> <span>Home</span></a></li>
            <li><a href="#about" class="nav-link scrollto"><i class="bx bx-user"></i> <span>Register</span></a></li>
    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <div class="row" data-aos="fade-in">
          ...
          <% ClientDetails cf=(ClientDetails)request.getAttribute("client"); 
	%>
 <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch">
 
            <form action="updatecontroller" method="post" role="form" class="php-email-form">
              <div class="row">
                <div class="form-group col-md-6">
                  <label for="name">Your Name</label>
                  <input type="text" value="<%=cf.getName()%>" name="name" placeholder="<%=cf.getName()%>" readonly class="form-control" id="name" required>
                </div>
                <div class="form-group col-md-6">
                  <label for="name">Your Email</label>
                  <input type="email" class="form-control" value="<%=cf.getEmail()%>" name="email" placeholder="example@gmail.com" id="email" required>
                </div>
              </div>
              <div class="form-group">
                <label for="name">WorkMode :</label>
                <input type="text" class="form-control" value="<%=cf.getMode() %>" name="mode" placeholder="online/offline" id="subject" required>
 
              </div>
                  
              <div class="form-group">
                <label for="name">Message</label>
                <input type="text" class="form-control" value="<%=cf.getMessage()%>" name="message" placeholder="Description of Project"  required>
              </div>  
